/* 
SUMMARY:
This JavaScript file powers the "Color Anomaly Detector" web app, handling image processing,
anomaly detection, and UI interactions. It includes:
- Image upload and canvas rendering with anomaly highlighting.
- Tabbed color selection (preset and custom) with an iro.js color wheel synced to RGB and CMYK sliders.
- Anomaly detection with clustering, sensitivity adjustments, and downloadable coordinates.
- Interactive features like heatmaps, info boxes, mouse coordinate tooltips, and a zoom box
  for anomalies.
*/
